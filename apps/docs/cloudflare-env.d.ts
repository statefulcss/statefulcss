/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b3c6a7d76793752051e9e22bbe8f409c)
// Runtime types generated with workerd@1.20260305.0 2026-02-09 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		WORKER_SELF_REFERENCE: Fetcher /* statefulcss-website */;
	}
}
