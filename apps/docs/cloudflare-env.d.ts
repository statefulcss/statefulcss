/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b3960abb6eb2c19539491c95b0b0e802)
// Runtime types generated with workerd@1.20260409.1 2026-02-09 nodejs_compat
declare namespace Cloudflare {
	interface PreviewEnv {
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* statefulcss-website-preview */;
	}
	interface Env {
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* statefulcss-website-preview */ | Fetcher /* statefulcss-website */;
